            ...
            with dpg.group():
                ...
                with dpg.child_window(width=int(viewport_width*0.33), height=int(viewport_height*0.082), horizontal_scrollbar=True, menubar=False, tag="child_window_eis_buttons"):
                    ...
                    with dpg.group(horizontal=True, tag="group_eis_display_file"):
                        ...
                        dpg.add_button(arrow=True, direction=dpg.mvDir_Left, tag="button_prev_display_file_eis",
                                       callback=lambda: gui_utils.file_list.step_display_file(config, -1))
                        dpg.add_button(arrow=True, direction=dpg.mvDir_Right, tag="button_next_display_file_eis",
                                       callback=lambda: gui_utils.file_list.step_display_file(config, +1))
